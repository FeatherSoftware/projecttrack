                        ...
                        <form method="post" action="{{ url('clientLogin') }}">
                         {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="email" id="ClientEmail" class="form-control" name="ClientEmail" value="{{old('ClientEmail')}}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="password" id="ClientPassword" class="form-control" name="ClientPassword"  required>
                                </div>
                            </div>
