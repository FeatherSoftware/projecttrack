...
<br>    
    ...
    <div class="container bg-light pb-5">
        <h5>General Information</h5>
                   <form method="post" action="{{ url('SubmitClient') }}" >
                    {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-3">

                        <input class="form-control" type="text" value="" name="ClientName" id="ClientName" required pattern="^[a-z A-Z]+$">
                         <div id="name-error"></div>
                        <span class="floating-label">Client Name<span  style="color:red">*</span></span>
                        <span id="adderrorname" style="color:red"></span>
                    </div>
                    <div class="col-md-3">
                        <input class="form-control" type="email" value="" name="ClientEmail" id="ClientEmail" required>
                        <span class="floating-label">Client Email<span  style="color:red">*</span></span>
                      
                    </div>
                    <div class="col-sm-3">
                        <input class="form-control" type="text" value="" name="ClientPassword" id="ClientPassword" required>
                        <span class="floating-label">Client Password<span  style="color:red">*</span></span>
                       
                    </div>
                   <div class="col-sm-3">
                        <input class="form-control" type="text" value="" name="ClientPhoneNumber" id="ClientPhoneNumber" >
