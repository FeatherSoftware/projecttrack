...
<br>    
    ...
    <div class="container bg-light pb-5">
       <div class="row">
                           @foreach($Employee as $EmployeeTable)
                          <?php ?>
   
     
                          <div class="col-md-3 col-sm-12 p-3" style="font-family: Microsoft Sans Serif ;">
                                  <div class="card" style="background-color:white;border-color: white">
                                  <img class="card-img-top avatar" src="{{'/images/'.$EmployeeTable->EmployeeImage }}" alt="Card image cap" style="border-radius: 50%;border-color:white;filter: drop-shadow(0 0 0.75rem #fc0303);">
                                  
                                  <div class="card-body">
                                          <h5 class="card-title mt-3" style="text-align:center">{{$EmployeeTable->EmployeeName}}</h5>
                                          <p class="card-text"><strong class="text-muted">status : <span style="color:#fc0303"> </span>Active</strong></p>
                                           <p class="card-text"><strong class="text-muted">dept : <span style="color:black;line-height: 0.25;"> {{$EmployeeTable->EmployeeDepartment}} </span></strong></p>
                                           <p class="card-text"><strong class="text-muted">role : <span style="color:black;line-height: 0.25;">{{$EmployeeTable->EmployeeRole}}  </span></strong></p>
                                  </div>
