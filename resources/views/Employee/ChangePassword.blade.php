      ...
      <br>
        ...
        <br>
                   <form method="post" action="{{ url('UpdatePassword') }}">
                    {{ csrf_field() }}
                   <input class="form-control" type="hidden" value="{{$Employee->EmployeeID}}" name="EmployeeID" id="EmployeeID" required>
                    <div class="row">
                      <div class="col-sm-3">
                        <input class="form-control" type="text" value="{{$Employee->EmployeePassword}}" name="" id="" readonly>
                         <div id="name-error"></div>
                        <span class="floating-label">Current Password<span  style="color:red">*</span></span>
                       ...
                       <div class="col-sm-3">
                        <input class="form-control" type="text" value="" name="EmployeePassword" id="EmployeePassword" required>
                         <div id="name-error"></div>
                        <span class="floating-label">New Password<span  style="color:red">*</span></span>
                        <span id="adderrorname" style="color:red"></span>
                      </div>
                      <div class="col-sm-3">
