                     ...
                     <div class="col-md-4 mt-4">
                          <div class="card" style="border-radius: 0.75rem;">
                              ...
                              <div class="card-body" id="ChecckInDiv">
                                      <h5 class="card-title">
                                        <br>
                                         <form method="post" action="{{ url('addAttendance') }}">
                                          {{ csrf_field() }}
                                            ...
                                            <input type="hidden" name="EmpID" id="EmpID" value="{{Session::get('EmployeeID')}}">
                                                ...
                                                @endif
                                                <?  date("Y-m-d H:i:s");?>
                                             <input type="hidden" name="EmployeeAttendanceCheckIn" value="<?php echo date("Y-m-d H:i:s");?>" id="EmployeeAttendanceCheckIn" >

                                           
          
                                            <div class="mt-3 pt-4 pb-4" style="border-radius: 50px;background:#D9F8F6">
                                                <span class="pl-3 pr-3">
                                                    <label>In</label>
                                                    <label class="switch float-right mr-3"  onchange="addin()"> 
                                                      <input type="submit" name="EmployeeCheckedIn" id="EmployeeCheckedIn"> 
