...
<br>    
    ...
    <div class="container bg-light pb-5">
        <h5>General Information</h5>
                   <form method="post" action="{{ url('SubmitProject') }}" >
                    {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-3">

                        <input class="form-control" type="text" value="" name="ProjectName" id="ProjectName" required>
                         <div id="name-error"></div>
                        <span class="floating-label">Project Name<span  style="color:red">*</span></span>
                        <span id="adderrorname" style="color:red"></span>
                    </div>
                    <div class="col-md-3">
                        <input class="form-control date" type="text" value="" name="ProjectStartDate" id="ProjectStartDate" required>
                        <span class="floating-label">Start Date<span  style="color:red">*</span></span>
                      
                    </div>
                    <div class="col-sm-3">
                        <input class="form-control date" type="text" value="" name="ProjectEstimatedDate" id="ProjectEstimatedDate">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control"  name="ProjectClientName" id="ProjectClientName">
                           @foreach($client as $ProjectClient)
                          <option value="{{$ProjectClient->ClientName}}">{{$ProjectClient->ClientName}}</option>
                          @endforeach
                        </select>
